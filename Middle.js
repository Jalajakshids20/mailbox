...
function Middle(props) {
  ...
  return (
    <div style={{marginLeft:"2.9vw",width:'75vw'}}>
        <img src={refresh} style={{width:"1.5vw",height:"1.5vw",marginLeft:"1.5vw",marginTop:"2vw"}}alt='text'/>
        {props.search ?  mailData.filter((data)=> data.sender == props.search).map((data)=>{
            ...
            <ListItem>
                {data.starred ? <img src={yellow} style={{cursor:"pointer",width:"1.4vw",height:"1.4vw"}}alt='text'/> 
                : <img onClick={()=>starred(data)} src={star} style={{cursor:"pointer",width:"1.4vw",height:"1.4vw"}}alt='text'/>}
                ...
                {show && <img onClick={()=>snoozed(data)} src={snooze} style={{marginLeft:"1vw",width:"1.3vw",height:"1.3vw",cursor:"pointer"}}alt='text'/>}
                {show && <img onClick={()=>deleteMail(data)} src={remove} style={{width:"1.1vw",height:"1.1vw"}}alt='text'/>}
            </ListItem>
           </Paper>
            </>
        })
       :  mailData.map((data)=>{
            ...
            {data.starred ? <img src={yellow} style={{cursor:"pointer",width:"1.4vw",height:"1.4vw"}} alt='text'/> 
                : <img onClick={()=>starred(data)} src={star} style={{cursor:"pointer",width:"1.4vw",height:"1.4vw"}}alt='text'/>}             
                  ...
                  {show && <img onClick={()=>snoozed(data)} src={snooze} style={{marginLeft:"1vw",width:"1.3vw",height:"1.3vw",cursor:"pointer"}}alt='text'/>}
                {show && <img  onClick={()=>deleteMail(data)} src={remove} style={{width:"1.1vw",height:"1.1vw",marginLeft:"1vw",cursor:"pointer"}}alt='text'/>}
            </ListItem>
           </Paper>
            </>
        })}
